  ...
  return (
    <aside className="flex h-full w-64 flex-col border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <div className="flex h-20 items-center border-b border-zinc-200 px-6 dark:border-zinc-800">
        <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900">
          D
        </div>
        <div>
      ...
      <nav className="flex-1 overflow-y-auto p-3">
        {menuGroups.map((group, idx) => (
          <div key={group.title} className={idx === 0 ? '' : 'mt-4'}>
            <p className="mb-2 mt-1 px-3 text-xs font-semibold tracking-wider text-zinc-500">
              {group.title}
            </p>
      ...
      <div className="space-y-2 border-t border-zinc-200 p-3 dark:border-zinc-800">
        {supportAndSettingsItems.map((item) => {
          ...
          return (
            <button
              key={item.key}
              type="button"
              className="group flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-zinc-500 transition hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-zinc-200"
            >
              <Icon className="h-4 w-4" />
        ...
        <Menu as="div" className="relative">
          <Menu.Button className="flex w-full items-center gap-3 rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2 text-left transition hover:border-zinc-300 hover:bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700 dark:hover:bg-zinc-800">
